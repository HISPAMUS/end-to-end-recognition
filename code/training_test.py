...
class ImageCache:
    ...
    def read_image(self, path):
        ...
        if path in self.__images:
            ...
            image = StaffsModificator.aply_pad(image)
...
class StaffsModificator:
    ...
    def aply_pad(image):
        ...
        image = np.pad(image, ((round(cols * 0.1),), (round(rows * 0.1),), (0,)), 'mean')
...
class DataReader:
    def __init__(self,
        ...
        self.TEST_SPLIT = 0
        self.VAL_SPLIT = 80
        self.TRAIN_SPLIT = 542
        
        images, regions, symbols, positions, joint = self.__lst.images, self.__lst.regions, self.__lst.symbols, self.__lst.positions, self.__lst.joint
